...
export const Contact = () => {
    return (
        <div className={`bg-[#111e62] h-[120vh] lg:h-[110vh]  md:h-[100vh]  w-full  
        ...
        `}>
            <div className=" md:mt-16 w-full md:w-[756px] lg:w-[1024px] xl:w-[1240px] flex flex-col lg:flex-row justify-start lg:justify-center items-center gap-x-20 ">
                <p className={` text-[#9baee9] font-1 text-center  text-[52px] md:text-[72px] lg:text-[92px] font-2 `}>Let's <br /> Talk</p>
                <form className=" mt-6 flex flex-col">
                              ...
                              h-[4rem] w-[18rem] sm:w-[20rem]  md:w-[26rem]   px-4 rounded-[13px]
                                placeholder:text-[#9baee9] font-1 font-bold text-[16px]
                                text-[#9baee9] 
                              border-2 border-[#9baee9]
                              ...
                              "/>
                                ...
                                <div className=" relative  borde-2 py-6">
                                        ...
                                        h-[4rem] w-[18rem] sm:w-[20rem]  md:w-[26rem]    px-4 rounded-[13px] text-[#9baee9]
                                        placeholder:text-[#9baee9] font-1 font-bold text-[16px]
                                        border-2 border-[#9baee9]
                                        outline-none bg-[#111e62] 
                                        "/>
            ...
            <div className=" bg-[#3943b3]
                          w-[80%] md:w-[64%] lg:w-[28%] xl:w-[22%]
                           h-[4rem]  xl:ml-[21rem] px-4 md:py-4  rounded-[13px]
